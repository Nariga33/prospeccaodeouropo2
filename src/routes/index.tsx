...
function Mentoria() {
  const slides = [
    ...
    },
    {
      ...
      chart: {
        headline: "3,2×",
        subtitle: <>mais reuniões qualificadas em times com <Jargon term="ICP">ICP</Jargon> documentado vs. listas no chute.</>,
        ...
        bullets: [
          <>Sem <Jargon term="ICP">ICP</Jargon>, ~60% do esforço vai para empresas que nunca vão comprar.</>,
          <>Listas direcionadas reduzem custo por reunião e encurtam o ciclo.</>,
          <>ICP escrito alinha marketing, <Jargon term="SDR">SDR</Jargon> e closer no mesmo perfil.</>,
        ],
      },
    },
    {
    ...
    },
    {
      ...
      chart: {
        headline: "-67%",
        subtitle: <>no ramp-up de um novo <Jargon term="SDR">SDR</Jargon> com playbook estruturado.</>,
        axisLabel: "Dias até novo SDR bater meta",
        unit: " dias",
        data: [
          ...
          <div className="rounded-3xl border border-gold/30 bg-card/70 p-7">
            <div key={`chart-${active}`} className="animate-fade-in">
              <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[10px] font-bold uppercase tracking-[0.25em] text-gold/70">
                ...
                <span className="text-xs font-normal normal-case tracking-normal text-foreground/80">{current.t}</span>
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-background/40 p-5">
                ...
                <div className="h-56 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chart.data} margin={{ top: 10, right: 16, left: -10, bottom: 0 }}>
