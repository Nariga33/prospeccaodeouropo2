...
const levels = [
  ...
  },
  {
    ...
    title: "Consciência",
    tag: "O que enxergo",
    desc: "Diagnosticamos a realidade da operação e revelamos o problema real, não o aparente.",
  },
  {
    n: "03",
    icon: MapIcon,
  ...
  },
  {
    ...
    title: "Jornada",
    tag: "O que executo",
    desc: "Acompanhamos a execução com disciplina, indicadores e evolução contínua.",
  },
  {
    n: "05",
    icon: Trophy,
...
const cycle: CycleItem[] = [
  {
    letter: "C",
    label: "Consciência",
    desc: "Enxergar a realidade da operação antes de agir. Diagnóstico honesto do que funciona, do que não funciona e por quê.",
  },
  {
    letter: "R",
    label: "Responsabilidade",
    desc: "Assumir o problema. Parar de terceirizar a culpa para o mercado, para o lead ou para a sorte.",
  },
  {
    letter: "E",
    label: "Estratégia",
    desc: "Desenhar o plano com ICP, cadência, abordagem e prioridade. Decisão clara antes da ação.",
  },
  {
    letter: "S",
    label: "Sistema",
    desc: "Processo replicável e documentado. Operação que funciona sem depender de esforço heróico.",
  },
  {
    letter: "C",
    label: "Constância",
    desc: "Execução diária com disciplina. Prospecção é regularidade, não pico de motivação.",
  },
  {
    letter: "E",
    label: "Evolução",
    desc: "Medir, ajustar e repetir. Cada ciclo melhora pitch, ICP e cadência com base em dados reais.",
  },
  {
    letter: "R",
    label: "Resultado",
  ...
  return (
    <div>
      ...
      <p className="mt-3 max-w-md text-sm text-muted-foreground">
        Saber o caminho não transforma ninguém. Percorrer o caminho, sim. Clique em cada nó para
        entender a etapa.
      </p>
      ...
      <div
        ...
        onKeyDown={(e) => {
          ...
          if (e.key === "ArrowLeft") {
            e.preventDefault();
            setActive((p) => (p - 1 + levels.length) % levels.length);
          }
        }}
      >
        <svg
        ...
        >
          ...
          <circle cx={cx} cy={cy} r={r + 30} fill="url(#po2JourneyGlow)" />
          ...
          {levels.map((l, i) => {
            ...
            return (
              <line
                ...
                x2={x}
                y2={y}
                stroke={isActive ? "rgba(197,160,89,0.7)" : "rgba(197,160,89,0.25)"}
          ...
          {levels.map((l, i) => {
            ...
            const Icon = l.icon;
            return (
              <g key={l.n} className="cursor-pointer" onClick={() => setActive(i)}>
                <circle
                  cx={x}
                  cy={y}
                  r="26"
                  ...
                  style={
                    isActive ? { filter: "drop-shadow(0 0 10px rgba(197,160,89,0.7))" } : undefined
                  }
                />
                <foreignObject
                  x={x - 10}
      ...
      <div className="mt-6 rounded-2xl border border-gold/30 bg-card/70 p-6">
        <div className="flex items-start gap-4">
          <span className="flex size-12 shrink-0 items-center justify-center rounded-xl border border-gold/40 bg-gold/10 text-gold">
          ...
          <div>
            ...
            <div className="mt-1 font-display text-2xl text-foreground">{current.title}</div>
        ...
        {[
          ...
          <div key={ex.before} className="rounded-xl border border-white/10 bg-card/50 p-4">
            <div className="flex gap-3 text-xs">
              <span className="w-14 shrink-0 font-bold uppercase tracking-[0.2em] text-red-300/80">
                Antes
              </span>
            ...
            <div className="flex gap-3 text-xs">
              <span className="w-14 shrink-0 font-bold uppercase tracking-[0.2em] text-gold">
                Depois
              </span>
