      ...
      <div className="mx-auto max-w-7xl px-6 py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-muted-foreground">
            ...
            e-mail e CRM numa cadência única, com métrica em cada etapa. Prospecção ativa de verdade
            não depende de um canal só.
          </p>
        </div>

        <div
          ref={wrapRef}
          className="relative mx-auto mt-16 flex max-w-[1100px] items-center justify-center"
        >
          <svg viewBox={`0 0 ${size} ${size}`} className="aspect-square w-full overflow-visible">
            ...
            <circle cx={cx} cy={cy} r={155} fill="#0F1115" stroke="#C5A059" strokeWidth="3" />
            <foreignObject x={cx - 92} y={cy - 92} width={184} height={184}>
              <div className="flex h-full w-full items-center justify-center">
                <img src={logo} alt="PO2" className="h-24 w-auto object-contain" />
              </div>
            </foreignObject>
