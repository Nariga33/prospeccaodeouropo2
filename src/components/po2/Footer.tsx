...
import { PO2_PHONE_DISPLAY, PO2_TEL_URL, PO2_WHATSAPP_URL } from "@/lib/contact";
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-10">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
            ...
            <Link to="/eventos" className="transition-colors hover:text-gold">Eventos</Link>
            <a href="/#planos" className="transition-colors hover:text-gold">Planos</a>
          </div>

          <div className="flex flex-col gap-2 text-sm">
            <a href={PO2_WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-foreground transition-colors hover:text-gold">
              <MessageCircle className="size-4 text-gold" /> WhatsApp
            </a>
            <a href={PO2_TEL_URL} className="flex items-center gap-2 text-muted-foreground transition-colors hover:text-gold">
